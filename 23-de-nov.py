            ...
            for category_odoo11 in categories_odoo11:
                ...
                for category_odoo14 in categories_odoo14:
                    ...
                    if category_odoo11['id'] == category_odoo14['id']:
                        ...
                        parent_path = self.convert_parent_path(category_odoo11['parent_left'], category_odoo11['parent_right'])

                        # Actualizar la categoría en Odoo 14 con el nuevo parent_path
                ...
                if not exist:
                    ...
                    query = f"""INSERT INTO product_category (id, name, parent_id, complete_name, parent_path, active, write_uid, write_date, create_date, create_uid)
                                VALUES ({category_odoo11['id']}, '{category_odoo11['name']}', {category_odoo11['parent_id']}, '{category_odoo11['complete_name']}', '{parent_path}', {category_odoo11['active']}, {category_odoo11['write_uid']}, '{category_odoo11['write_date']}', '{category_odoo11['create_date']}', {category_odoo11['create_uid']})"""
