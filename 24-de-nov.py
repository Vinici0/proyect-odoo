        ...
        try:
            ...
            for category_odoo11 in categories_odoo11:
                ...
                if not exist:
                    ...
                    query = f"""INSERT INTO product_category (id, name, parent_id, write_uid, create_uid, write_date, create_date, parent_path, complete_name)
                                VALUES ({category_odoo11['id']}, '{category_odoo11['name']}' , {category_odoo11['parent_id']}, {category_odoo11['write_uid']}, {category_odoo11['create_uid']}, '{category_odoo11['write_date']}','{category_odoo11['create_date']}'), '{parent_path}'"""
